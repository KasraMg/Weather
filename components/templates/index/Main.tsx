...
const Main = () => {
    return (
        <div className="flex justify-center text-center relative z-30 flex-col pt-28">
            <img  className="mx-auto w-[230px]"  src="/images/logo-removebg-preview.png" alt="wind" />
            <span className="font-arturo text-[15px] my-2 text-gray-400">Wlc to Storm Seeker</span>
            <section className='w-[700px] mx-auto relative my-3'>
            ...
            <p className="text-[14px] font-quicksand ">Get informed about the weather in all parts of the world</p>
        </div>
    )
}
