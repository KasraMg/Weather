...
const Card = (props: City) => {
  ...
  return (
    <Link
      ...
      className="w-[500px] lg:w-[350px] md:!w-full h-max rounded flex justify-between p-3 relative z-30 "
      style={{ boxShadow: " 0px 19px 70px 11px rgba(0,0,0,0.5)" }}
    >
      <div>
      ...
      <div className="text-center ">
        <p className="mb-3 mt-1 w-max ml-auto bg-[#0984e3] rounded-md px-2 pb-1">
          Now
        </p>
        <p className=" mb-2 ml-2  ">
          {temp.substring(0, 2) + "." + temp.substring(2, 3)} ° C
        </p>
