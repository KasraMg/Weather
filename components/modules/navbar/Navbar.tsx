    ...
    return (
        <nav className="z-20 relative pt-3 flex justify-between px-8 items-center">
            <ul className="flex items-center gap-8 z-30 sm-x2:w-full sm-x2:justify-between sm-x2:pt-4  font-arturo">
                <Link href={'/'} className={`${path === "/" && "active"}  hover:text-[#0984e3] cursor-pointer transition-colors`}>Home</Link>
                <Link href={'/explore'} className={`${path === "/explore" && "active"} hover:text-[#0984e3] cursor-pointer transition-colors`}>Explore</Link>
                <Link href={'/support'} className={`${path === "/support" && "active"} hover:text-[#0984e3] cursor-pointer transition-colors`}>Support</Link>
            </ul>
